...
namespace Modules\HMS\App\Http\Controllers\Global;
...
class Autocomplete extends Controller{
    ...
    public function index(Request $request){
        ...
        try { 
            ...
            if($validater->fails()){
                return  Helper::errorResponse(Helper::validationErrorsToString($validater->errors()),400);
            }
            
            if($request->table == 'users') return Helper::errorResponse("Data Is not Allowed to retrieve from this table");
