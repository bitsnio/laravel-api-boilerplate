...
* @method static \Bitsnio\Modules\Collection toCollection()
...
* @method static \Bitsnio\Modules\Module find( string $name )
* @method static \Bitsnio\Modules\Module findOrFail( string $name )
